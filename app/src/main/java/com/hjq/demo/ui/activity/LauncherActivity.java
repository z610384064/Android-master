 ...
 *    desc   : 启动界面
 */
public class LauncherActivity extends MyActivity implements OnPermission, Animation.AnimationListener {

    @BindView(R.id.iv_launcher_bg)
    View mImageView; //整个布局
    ...
    private void initStartAnim() {
        ...
        aa.setAnimationListener(this); //透明动画
        mImageView.startAnimation(aa);

        ScaleAnimation sa = new ScaleAnimation(0, 1, 0, 1, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
        sa.setDuration(ANIM_TIME); //大小动画,从1变为1
        ...
        ra.setDuration(ANIM_TIME);  //旋转动画
        mTextView.startAnimation(ra);
    }

    private void requestFilePermission() {
        XXPermissions.with(this)
                .permission(Permission.Group.STORAGE,Permission.Group.CONTACTS)
                .request(this);
    }
    ...
    protected void onRestart() {
        super.onRestart();
        if (XXPermissions.isHasPermission(LauncherActivity.this, Permission.Group.STORAGE,Permission.Group.CONTACTS)) {
